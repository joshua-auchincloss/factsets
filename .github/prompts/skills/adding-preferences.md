...
```typescript
export type PreferenceNewOption = "value1" | "value2" | "value3";
```
...
Files docs/_.md and src/prompts/_.md should stay synchronized. The prompts/ versions are used by the MCP server at runtime.
